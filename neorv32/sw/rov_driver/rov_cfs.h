...
// --- Internal ---
static void _rov_cmd(uint8_t cmd_byte, uint32_t value) {
...
int16_t rov_read_imu_yaw(void) {
    _rov_cmd(0, 0);
    return (int16_t)((CFS_REG4 >> 0) & 0xFFFF);
}
...
int16_t rov_read_pid_output(int axis) {
    ...
    uint32_t reg;
    switch (axis) {
        case 0: reg = CFS_REG4; return (int16_t)((reg >> 16) & 0xFFFF);
        case 1: reg = CFS_REG5; return (int16_t)((reg >> 0) & 0xFFFF);
        case 2: reg = CFS_REG5; return (int16_t)((reg >> 16) & 0xFFFF);
        case 3: reg = CFS_REG6; return (int16_t)((reg >> 0) & 0xFFFF);
        case 4: reg = CFS_REG6; return (int16_t)((reg >> 16) & 0xFFFF);
        case 5: reg = CFS_REG7; return (int16_t)((reg >> 0) & 0xFFFF);
        default: return 0;
    }
}
...
uint16_t rov_read_depth_cm(void) {
    _rov_cmd(0, 0);
    return (uint16_t)((CFS_REG7 >> 16) & 0xFFFF);
}
